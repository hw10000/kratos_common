...
var file_server_v1_server_proto_rawDesc = string([]byte{
	...
	0x74, 0x65, 0x6d, 0x52, 0x06, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x22, 0x46, 0x0a, 0x12, 0x4d,
	0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x49, 0x74, 0x65,
	...
	0x67, 0x68, 0x74, 0x22, 0x63, 0x0a, 0x1a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x75, 0x6c,
	0x74, 0x69, 0x53, 0x69, 0x67, 0x6e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x2c, 0x0a, 0x12, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x5f,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x6d,
	0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12,
	0x17, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x32, 0xe5, 0x08, 0x0a, 0x07, 0x41, 0x64, 0x64,
	...
	0x42, 0x3b, 0x0a, 0x0d, 0x61, 0x70, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x50, 0x01, 0x5a, 0x28, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69,
...
var file_server_v1_server_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
...
var file_server_v1_server_proto_depIdxs = []int32{
	...
	0,  // 9: api.server.v1.Address.CreateAddress:input_type -> api.server.v1.CreateAddressRequest
	15, // 10: api.server.v1.Address.CreateAddressBatch:input_type -> api.server.v1.CreateAddressBatchRequest
	2,  // 11: api.server.v1.Address.StoreSecret:input_type -> api.server.v1.StoreSecretRequest
	5,  // 12: api.server.v1.Address.DecodeSecret:input_type -> api.server.v1.DecodeSecretRequest
	7,  // 13: api.server.v1.Address.StoreSecretBatch:input_type -> api.server.v1.StoreSecretBatchRequest
	9,  // 14: api.server.v1.Address.DecodeSecretBatch:input_type -> api.server.v1.DecodeSecretBatchRequest
	11, // 15: api.server.v1.Address.SignTx:input_type -> api.server.v1.SignTxRequest
	13, // 16: api.server.v1.Address.SignTxBatch:input_type -> api.server.v1.SignTxBatchRequest
	17, // 17: api.server.v1.Address.Withdrawal:input_type -> api.server.v1.WithdrawalRequest
	21, // 18: api.server.v1.Address.GetOrderDetail:input_type -> api.server.v1.GetOrderDetailRequest
	23, // 19: api.server.v1.Address.CreateMultiSignTransfer:input_type -> api.server.v1.CreateMultiSignTransferRequest
	25, // 20: api.server.v1.Address.CreateMultiSignWallet:input_type -> api.server.v1.CreateMultiSignWalletRequest
	1,  // 21: api.server.v1.Address.CreateAddress:output_type -> api.server.v1.CreateAddressReply
	16, // 22: api.server.v1.Address.CreateAddressBatch:output_type -> api.server.v1.CreateAddressBatchReply
	4,  // 23: api.server.v1.Address.StoreSecret:output_type -> api.server.v1.StoreSecretReply
	6,  // 24: api.server.v1.Address.DecodeSecret:output_type -> api.server.v1.DecodeSecretReply
	8,  // 25: api.server.v1.Address.StoreSecretBatch:output_type -> api.server.v1.StoreSecretBatchReply
	10, // 26: api.server.v1.Address.DecodeSecretBatch:output_type -> api.server.v1.DecodeSecretBatchReply
	12, // 27: api.server.v1.Address.SignTx:output_type -> api.server.v1.SignTxReply
	14, // 28: api.server.v1.Address.SignTxBatch:output_type -> api.server.v1.SignTxBatchReply
	18, // 29: api.server.v1.Address.Withdrawal:output_type -> api.server.v1.WithdrawalReply
	22, // 30: api.server.v1.Address.GetOrderDetail:output_type -> api.server.v1.GetOrderDetailReply
	24, // 31: api.server.v1.Address.CreateMultiSignTransfer:output_type -> api.server.v1.CreateMultiSignTransferReply
	27, // 32: api.server.v1.Address.CreateMultiSignWallet:output_type -> api.server.v1.CreateMultiSignWalletReply
