...
var file_server_v1_server_proto_rawDesc = string([]byte{
	...
	0x73, 0x32, 0xd0, 0x0a, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x57, 0x0a,
...
var file_server_v1_server_proto_depIdxs = []int32{
	...
	1,  // 25: api.server.v1.Address.CreateAddress:output_type -> api.server.v1.CreateAddressReply
	16, // 26: api.server.v1.Address.CreateAddressBatch:output_type -> api.server.v1.CreateAddressBatchReply
	4,  // 27: api.server.v1.Address.StoreSecret:output_type -> api.server.v1.StoreSecretReply
	6,  // 28: api.server.v1.Address.DecodeSecret:output_type -> api.server.v1.DecodeSecretReply
	8,  // 29: api.server.v1.Address.StoreSecretBatch:output_type -> api.server.v1.StoreSecretBatchReply
	10, // 30: api.server.v1.Address.DecodeSecretBatch:output_type -> api.server.v1.DecodeSecretBatchReply
	12, // 31: api.server.v1.Address.SignTx:output_type -> api.server.v1.SignTxReply
	14, // 32: api.server.v1.Address.SignTxBatch:output_type -> api.server.v1.SignTxBatchReply
	18, // 33: api.server.v1.Address.Withdrawal:output_type -> api.server.v1.WithdrawalReply
	22, // 34: api.server.v1.Address.GetOrderDetail:output_type -> api.server.v1.GetOrderDetailReply
	24, // 35: api.server.v1.Address.CreateMultiSignTransfer:output_type -> api.server.v1.CreateMultiSignTransferReply
	27, // 36: api.server.v1.Address.CreateMultiSignWallet:output_type -> api.server.v1.CreateMultiSignWalletReply
	31, // 37: api.server.v1.Address.GetMultiSignWalletTxList:output_type -> api.server.v1.GetMultiSignWalletTxListReply
	33, // 38: api.server.v1.Address.CheckMultiSignAddress:output_type -> api.server.v1.CheckMultiSignAddressReply
