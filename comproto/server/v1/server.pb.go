...
var file_server_v1_server_proto_rawDesc = string([]byte{
	...
	0x6c, 0x52, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0xda,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x30, 0x0a, 0x1c, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x6e, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x75,
	0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x32, 0xf4, 0x07,
...
var file_server_v1_server_proto_depIdxs = []int32{
	...
	23, // 18: api.server.v1.Address.CreateMultiSignTransfer:input_type -> api.server.v1.CreateMultiSignTransferRequest
	1,  // 19: api.server.v1.Address.CreateAddress:output_type -> api.server.v1.CreateAddressReply
	16, // 20: api.server.v1.Address.CreateAddressBatch:output_type -> api.server.v1.CreateAddressBatchReply
	4,  // 21: api.server.v1.Address.StoreSecret:output_type -> api.server.v1.StoreSecretReply
	6,  // 22: api.server.v1.Address.DecodeSecret:output_type -> api.server.v1.DecodeSecretReply
	8,  // 23: api.server.v1.Address.StoreSecretBatch:output_type -> api.server.v1.StoreSecretBatchReply
	10, // 24: api.server.v1.Address.DecodeSecretBatch:output_type -> api.server.v1.DecodeSecretBatchReply
	12, // 25: api.server.v1.Address.SignTx:output_type -> api.server.v1.SignTxReply
	14, // 26: api.server.v1.Address.SignTxBatch:output_type -> api.server.v1.SignTxBatchReply
	18, // 27: api.server.v1.Address.Withdrawal:output_type -> api.server.v1.WithdrawalReply
	22, // 28: api.server.v1.Address.GetOrderDetail:output_type -> api.server.v1.GetOrderDetailReply
	24, // 29: api.server.v1.Address.CreateMultiSignTransfer:output_type -> api.server.v1.CreateMultiSignTransferReply
