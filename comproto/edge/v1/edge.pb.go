...
type GetOrderDetailReply struct {
	...
	Status             string                 `protobuf:"bytes,4,opt,name=status,proto3" json:"status,omitempty"`                         // 订单状态 0:待支付 1:已支付 2:等待上链 3:上链成功 4:异常
	Message            string                 `protobuf:"bytes,5,opt,name=message,proto3" json:"message,omitempty"`                       // 订单状态描述
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
var file_edge_v1_edge_proto_rawDesc = string([]byte{
	...
	0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0xbb, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4f, 0x72,
	...
	0x73, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01,
	...
	0x73, 0x61, 0x67, 0x65, 0x32, 0xc0, 0x05, 0x0a, 0x04, 0x45, 0x64, 0x67, 0x65, 0x12, 0x70, 0x0a,
