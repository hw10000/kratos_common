...
type SendTransactionWithBundleRequest struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Chain             string                 `protobuf:"bytes,1,opt,name=chain,proto3" json:"chain,omitempty"`                                                  // 链名称
	Network           string                 `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"`                                              // 网络名称
	SignedTransaction []string               `protobuf:"bytes,3,rep,name=signed_transaction,json=signedTransaction,proto3" json:"signed_transaction,omitempty"` // 交易，字符串
...
func (x *SendTransactionWithBundleRequest) Reset() {
	*x = SendTransactionWithBundleRequest{}
	mi := &file_block_v1_block_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SendTransactionWithBundleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendTransactionWithBundleRequest) ProtoMessage() {}

func (x *SendTransactionWithBundleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendTransactionWithBundleRequest.ProtoReflect.Descriptor instead.
func (*SendTransactionWithBundleRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{13}
}

func (x *SendTransactionWithBundleRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *SendTransactionWithBundleRequest) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *SendTransactionWithBundleRequest) GetSignedTransaction() []string {
	if x != nil {
		return x.SignedTransaction
	}
	return nil
...
type SendTransactionWithBundleReply struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	BundleHash      string                 `protobuf:"bytes,1,opt,name=bundle_hash,json=bundleHash,proto3" json:"bundle_hash,omitempty"`                //捆绑包Hash
	TransactionHash []string               `protobuf:"bytes,2,rep,name=transaction_hash,json=transactionHash,proto3" json:"transaction_hash,omitempty"` // 交易哈希 如果成功则有hash，且msg返回success
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *SendTransactionWithBundleReply) Reset() {
	*x = SendTransactionWithBundleReply{}
	mi := &file_block_v1_block_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SendTransactionWithBundleReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendTransactionWithBundleReply) ProtoMessage() {}

func (x *SendTransactionWithBundleReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendTransactionWithBundleReply.ProtoReflect.Descriptor instead.
func (*SendTransactionWithBundleReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{14}
}

func (x *SendTransactionWithBundleReply) GetBundleHash() string {
	if x != nil {
		return x.BundleHash
	}
	return ""
...
func (x *SendTransactionWithBundleReply) GetTransactionHash() []string {
	if x != nil {
		return x.TransactionHash
	}
	return nil
...
type TransferRequest struct {
	...
	IsMultiSig    bool                   `protobuf:"varint,8,opt,name=is_multi_sig,json=isMultiSig,proto3" json:"is_multi_sig,omitempty"`    // 是否为多签
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TransferRequest) GetIsMultiSig() bool {
	if x != nil {
		return x.IsMultiSig
	}
	return false
...
type GetUserResourceRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Chain         string                 `protobuf:"bytes,1,opt,name=chain,proto3" json:"chain,omitempty"`     // 链名称
	Network       string                 `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"` // 网络名称
	Address       string                 `protobuf:"bytes,3,opt,name=address,proto3" json:"address,omitempty"` // 地址
...
func (x *GetUserResourceRequest) Reset() {
	*x = GetUserResourceRequest{}
	mi := &file_block_v1_block_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetUserResourceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserResourceRequest) ProtoMessage() {}

func (x *GetUserResourceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[50]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserResourceRequest.ProtoReflect.Descriptor instead.
func (*GetUserResourceRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{50}
}

func (x *GetUserResourceRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *GetUserResourceRequest) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *GetUserResourceRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
type GetUserResourceReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserBandwidth int64                  `protobuf:"varint,1,opt,name=user_bandwidth,json=userBandwidth,proto3" json:"user_bandwidth,omitempty"` // 用户带宽
	UserEnergy    int64                  `protobuf:"varint,2,opt,name=user_energy,json=userEnergy,proto3" json:"user_energy,omitempty"`          // 用户能量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetUserResourceReply) Reset() {
	*x = GetUserResourceReply{}
	mi := &file_block_v1_block_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetUserResourceReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserResourceReply) ProtoMessage() {}

func (x *GetUserResourceReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[51]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserResourceReply.ProtoReflect.Descriptor instead.
func (*GetUserResourceReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{51}
}

func (x *GetUserResourceReply) GetUserBandwidth() int64 {
	if x != nil {
		return x.UserBandwidth
	}
	return 0
...
func (x *GetUserResourceReply) GetUserEnergy() int64 {
	if x != nil {
		return x.UserEnergy
	}
	return 0
...
func (x *GetTransferDetailRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *GetTransferDetailRequest) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *GetTransferDetailRequest) GetTransactionHash() string {
	if x != nil {
		return x.TransactionHash
	}
	return ""
...
type GetTransferDetailReply struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	BlockNumber     int64                  `protobuf:"varint,1,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`            // 区块号
	BlockTime       int64                  `protobuf:"varint,2,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`                  // 区块时间
	FromAddress     string                 `protobuf:"bytes,3,opt,name=from_address,json=fromAddress,proto3" json:"from_address,omitempty"`             // 发送地址
	ToAddress       string                 `protobuf:"bytes,4,opt,name=to_address,json=toAddress,proto3" json:"to_address,omitempty"`                   // 接收地址
	Value           string                 `protobuf:"bytes,5,opt,name=value,proto3" json:"value,omitempty"`                                            // 转账金额
	Hash            string                 `protobuf:"bytes,6,opt,name=hash,proto3" json:"hash,omitempty"`                                              // 交易哈希
	ContractAddress string                 `protobuf:"bytes,7,opt,name=contract_address,json=contractAddress,proto3" json:"contract_address,omitempty"` // 合约地址
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *GetTransferDetailReply) Reset() {
	*x = GetTransferDetailReply{}
	mi := &file_block_v1_block_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTransferDetailReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTransferDetailReply) ProtoMessage() {}

func (x *GetTransferDetailReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTransferDetailReply.ProtoReflect.Descriptor instead.
func (*GetTransferDetailReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{53}
}

func (x *GetTransferDetailReply) GetBlockNumber() int64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *GetTransferDetailReply) GetBlockTime() int64 {
	if x != nil {
		return x.BlockTime
	}
	return 0
...
func (x *GetTransferDetailReply) GetFromAddress() string {
	if x != nil {
		return x.FromAddress
	}
	return ""
...
func (x *GetTransferDetailReply) GetToAddress() string {
	if x != nil {
		return x.ToAddress
	}
	return ""
...
func (x *GetTransferDetailReply) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *GetTransferDetailReply) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
func (x *GetTransferDetailReply) GetContractAddress() string {
	if x != nil {
		return x.ContractAddress
	}
	return ""
...
type GetTokenBalanceBatchByItemRequest struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	BalanceItems  []*GetTokenBalanceRequest `protobuf:"bytes,1,rep,name=balance_items,json=balanceItems,proto3" json:"balance_items,omitempty"` // 批量请求
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetTokenBalanceBatchByItemRequest) Reset() {
	*x = GetTokenBalanceBatchByItemRequest{}
	mi := &file_block_v1_block_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTokenBalanceBatchByItemRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTokenBalanceBatchByItemRequest) ProtoMessage() {}

func (x *GetTokenBalanceBatchByItemRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTokenBalanceBatchByItemRequest.ProtoReflect.Descriptor instead.
func (*GetTokenBalanceBatchByItemRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{54}
}

func (x *GetTokenBalanceBatchByItemRequest) GetBalanceItems() []*GetTokenBalanceRequest {
	if x != nil {
		return x.BalanceItems
	}
	return nil
...
type GetTokenBalanceBatchByItemReply struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	BalanceResult []*GetTokenBalanceReply `protobuf:"bytes,1,rep,name=balance_result,json=balanceResult,proto3" json:"balance_result,omitempty"` // 地址到余额信息的映射
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetTokenBalanceBatchByItemReply) Reset() {
	*x = GetTokenBalanceBatchByItemReply{}
	mi := &file_block_v1_block_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetTokenBalanceBatchByItemReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTokenBalanceBatchByItemReply) ProtoMessage() {}

func (x *GetTokenBalanceBatchByItemReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTokenBalanceBatchByItemReply.ProtoReflect.Descriptor instead.
func (*GetTokenBalanceBatchByItemReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{55}
}

func (x *GetTokenBalanceBatchByItemReply) GetBalanceResult() []*GetTokenBalanceReply {
	if x != nil {
		return x.BalanceResult
	}
	return nil
...
func (x *GetChainIDRequest) Reset() {
	*x = GetChainIDRequest{}
	mi := &file_block_v1_block_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetChainIDRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{56}
}

func (x *GetChainIDRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *GetChainIDRequest) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
type GetChainIDReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChainId       uint32                 `protobuf:"varint,1,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"` // 链ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetChainIDReply) Reset() {
	*x = GetChainIDReply{}
	mi := &file_block_v1_block_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetChainIDReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetChainIDReply) ProtoMessage() {}

func (x *GetChainIDReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[57]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetChainIDReply.ProtoReflect.Descriptor instead.
func (*GetChainIDReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{57}
}

func (x *GetChainIDReply) GetChainId() uint32 {
	if x != nil {
		return x.ChainId
	}
	return 0
...
type BuildUpgradeMultiSigWalletTxRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Chain         string                 `protobuf:"bytes,1,opt,name=chain,proto3" json:"chain,omitempty"`                                   // 链名称
	Network       string                 `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"`                               // 网络名称
	CurrentOwner  string                 `protobuf:"bytes,3,opt,name=current_owner,json=currentOwner,proto3" json:"current_owner,omitempty"` // 当前需要升级的钱包地址
...
func (x *BuildUpgradeMultiSigWalletTxRequest) Reset() {
	*x = BuildUpgradeMultiSigWalletTxRequest{}
	mi := &file_block_v1_block_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildUpgradeMultiSigWalletTxRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildUpgradeMultiSigWalletTxRequest) ProtoMessage() {}

func (x *BuildUpgradeMultiSigWalletTxRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildUpgradeMultiSigWalletTxRequest.ProtoReflect.Descriptor instead.
func (*BuildUpgradeMultiSigWalletTxRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{58}
}

func (x *BuildUpgradeMultiSigWalletTxRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *BuildUpgradeMultiSigWalletTxRequest) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *BuildUpgradeMultiSigWalletTxRequest) GetCurrentOwner() string {
	if x != nil {
...
func (x *BuildUpgradeMultiSigWalletTxRequest) GetThreshold() uint32 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *BuildUpgradeMultiSigWalletTxRequest) GetOwners() []*MultiSigWalletItem {
	if x != nil {
		return x.Owners
	}
	return nil
...
type BuildUpgradeMultiSigWalletTxReply struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RawTransaction string                 `protobuf:"bytes,1,opt,name=raw_transaction,json=rawTransaction,proto3" json:"raw_transaction,omitempty"` // 交易
	...
	SubPvk         *string                `protobuf:"bytes,3,opt,name=sub_pvk,json=subPvk,proto3,oneof" json:"sub_pvk,omitempty"`                   // 子私钥Solana专用
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *BuildUpgradeMultiSigWalletTxReply) Reset() {
	*x = BuildUpgradeMultiSigWalletTxReply{}
	mi := &file_block_v1_block_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildUpgradeMultiSigWalletTxReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildUpgradeMultiSigWalletTxReply) ProtoMessage() {}

func (x *BuildUpgradeMultiSigWalletTxReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildUpgradeMultiSigWalletTxReply.ProtoReflect.Descriptor instead.
func (*BuildUpgradeMultiSigWalletTxReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{60}
}

func (x *BuildUpgradeMultiSigWalletTxReply) GetRawTransaction() string {
	if x != nil {
		return x.RawTransaction
	}
	return ""
...
func (x *BuildUpgradeMultiSigWalletTxReply) GetWalletAddress() string {
	if x != nil {
...
func (x *BuildUpgradeMultiSigWalletTxReply) GetSubPvk() string {
	if x != nil && x.SubPvk != nil {
		return *x.SubPvk
	}
	return ""
}
...
func (x *GetTransactionWeightRequest) Reset() {
	*x = GetTransactionWeightRequest{}
	mi := &file_block_v1_block_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetTransactionWeightRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{61}
}
...
func (x *SignerInfo) Reset() {
	*x = SignerInfo{}
	mi := &file_block_v1_block_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignerInfo) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{62}
}
...
func (x *SignerInfo) GetWeight() uint32 {
	if x != nil {
		return x.Weight
	}
	return 0
...
type GetTransactionWeightReply struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	ThresholdWeight  uint32                 `protobuf:"varint,1,opt,name=threshold_weight,json=thresholdWeight,proto3" json:"threshold_weight,omitempty"`   // 总权重门槛
	Permissions      []*SignerInfo          `protobuf:"bytes,2,rep,name=permissions,proto3" json:"permissions,omitempty"`                                   // 全部可以签名的地址和权重列表
	ApprovedList     []*SignerInfo          `protobuf:"bytes,3,rep,name=approved_list,json=approvedList,proto3" json:"approved_list,omitempty"`             // 当前已经签名的地址和权重列表
	RemainingWeight  uint32                 `protobuf:"varint,4,opt,name=remaining_weight,json=remainingWeight,proto3" json:"remaining_weight,omitempty"`   // 剩余所需的权重
	AvailableSigners []*SignerInfo          `protobuf:"bytes,5,rep,name=available_signers,json=availableSigners,proto3" json:"available_signers,omitempty"` // 可选的签名地址+权重列表（排除已签名的）
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetTransactionWeightReply) Reset() {
	*x = GetTransactionWeightReply{}
	mi := &file_block_v1_block_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetTransactionWeightReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{63}
}
...
func (x *GetTransactionWeightReply) GetPermissions() []*SignerInfo {
	if x != nil {
...
func (x *GetTransactionWeightReply) GetApprovedList() []*SignerInfo {
	if x != nil {
...
func (x *GetTransactionWeightReply) GetRemainingWeight() uint32 {
	if x != nil {
...
func (x *GetTransactionWeightReply) GetAvailableSigners() []*SignerInfo {
	if x != nil {
		return x.AvailableSigners
	}
	return nil
}
...
func (x *GetMultiSignWalletTxListRequest) Reset() {
	*x = GetMultiSignWalletTxListRequest{}
	mi := &file_block_v1_block_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMultiSignWalletTxListRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{64}
}
...
func (x *SignItem) Reset() {
	*x = SignItem{}
	mi := &file_block_v1_block_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignItem) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{65}
}
...
type MultiSignWalletTxItem struct {
	...
	OriginatorAddress string                 `protobuf:"bytes,12,opt,name=originator_address,json=originatorAddress,proto3" json:"originator_address,omitempty"` //发起地址
	CurrentWeight     int32                  `protobuf:"varint,13,opt,name=current_weight,json=currentWeight,proto3" json:"current_weight,omitempty"`            //当前交易权重
	ExpiredTime       string                 `protobuf:"bytes,14,opt,name=expired_time,json=expiredTime,proto3" json:"expired_time,omitempty"`                   //过期时间
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *MultiSignWalletTxItem) Reset() {
	*x = MultiSignWalletTxItem{}
	mi := &file_block_v1_block_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MultiSignWalletTxItem) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{66}
}
...
func (x *MultiSignWalletTxItem) GetOriginatorAddress() string {
	if x != nil {
...
func (x *MultiSignWalletTxItem) GetCurrentWeight() int32 {
	if x != nil {
...
func (x *MultiSignWalletTxItem) GetExpiredTime() string {
	if x != nil {
...
func (x *GetMultiSignWalletTxListReply) Reset() {
	*x = GetMultiSignWalletTxListReply{}
	mi := &file_block_v1_block_proto_msgTypes[67]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMultiSignWalletTxListReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{67}
}
...
func (x *GetMultiSignWalletTxListReply) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetMultiSignWalletTxListReply) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *GetMultiSignWalletTxListReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
type CheckMultiSignAddressRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Chain         string                 `protobuf:"bytes,1,opt,name=chain,proto3" json:"chain,omitempty"`
	Network       string                 `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"`
	Address       string                 `protobuf:"bytes,3,opt,name=address,proto3" json:"address,omitempty"` //地址
...
func (x *CheckMultiSignAddressRequest) Reset() {
	*x = CheckMultiSignAddressRequest{}
	mi := &file_block_v1_block_proto_msgTypes[68]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckMultiSignAddressRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckMultiSignAddressRequest) ProtoMessage() {}

func (x *CheckMultiSignAddressRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[68]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckMultiSignAddressRequest.ProtoReflect.Descriptor instead.
func (*CheckMultiSignAddressRequest) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{68}
}

func (x *CheckMultiSignAddressRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *CheckMultiSignAddressRequest) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *CheckMultiSignAddressRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
type CheckMultiSignAddressReply struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	IsMultiSignAddress bool                   `protobuf:"varint,1,opt,name=is_multi_sign_address,json=isMultiSignAddress,proto3" json:"is_multi_sign_address,omitempty"` //是否为多签地址
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *CheckMultiSignAddressReply) Reset() {
	*x = CheckMultiSignAddressReply{}
	mi := &file_block_v1_block_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckMultiSignAddressReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckMultiSignAddressReply) ProtoMessage() {}

func (x *CheckMultiSignAddressReply) ProtoReflect() protoreflect.Message {
	mi := &file_block_v1_block_proto_msgTypes[69]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckMultiSignAddressReply.ProtoReflect.Descriptor instead.
func (*CheckMultiSignAddressReply) Descriptor() ([]byte, []int) {
	return file_block_v1_block_proto_rawDescGZIP(), []int{69}
}

func (x *CheckMultiSignAddressReply) GetIsMultiSignAddress() bool {
	if x != nil {
		return x.IsMultiSignAddress
	}
	return false
}
...
var file_block_v1_block_proto_rawDesc = string([]byte{
	...
	0x71, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	...
	,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x18, 0x02,
	...
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0xe3, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x74,
	...
	0x6b, 0x65, 0x6e, 0x5f, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x25, 0x0a,
	0x0e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x64, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x73, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x44, 0x65, 0x63, 0x69,
	0x6d, 0x61, 0x6c, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x74, 0x6f,
	...
	0x6c, 0x79, 0x12, 0x37, 0x0a, 0x18, 0x70, 0x61, 0x72, 0x73, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x70, 0x61, 0x72, 0x73, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x22, 0x5c, 0x0a, 0x18, 0x47,
	0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x61, 0x74, 0x63, 0x68,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a, 0x0a, 0x69, 0x6e, 0x66, 0x6f, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x29, 0x0a, 0x10, 0x74, 0x72, 0x61, 0x6e,
	...
	0x61, 0x73, 0x68, 0x22, 0x4b, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	0x22, 0x76, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x45, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x72, 0x55,
	0x52, 0x4c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x68, 0x61,
	...
	,
	...
	0x72, 0x6b, 0x22, 0x67, 0x0a, 0x19, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x34, 0x0a, 0x09, 0x53, 0x77, 0x61, 0x70, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x72, 0x61, 0x77, 0x5f, 0x74, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x72,
	0x61, 0x77, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x87, 0x02,
	...
	0x6b, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x21,
	0x0a, 0x0c, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x05,
	...
	0x12, 0x19, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x48,
	0x00, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x88, 0x01, 0x01, 0x12, 0x20, 0x0a, 0x0c, 0x69,
	0x73, 0x5f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x5f, 0x73, 0x69, 0x67, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0a, 0x69, 0x73, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x42, 0x08, 0x0a,
	0x06, 0x5f, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0xaa, 0x01, 0x0a, 0x0d, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x72, 0x61, 0x77,
	...
	,
	...
	0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x04, 0x20,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74,
	...
	0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x37, 0x0a, 0x0c, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65,
	...
	0x72, 0x61, 0x77, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x55,
	0x0a, 0x11, 0x43, 0x61, 0x6c, 0x6c, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x68, 0x0a, 0x1d, 0x53, 0x65, 0x6e, 0x64, 0x50, 0x72, 0x69, 0x76,
	0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x61, 0x77, 0x5f, 0x74, 0x78, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x72, 0x61, 0x77, 0x54, 0x78, 0x73, 0x12, 0x14,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x35,
	0x0a, 0x1b, 0x53, 0x65, 0x6e, 0x64, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x16, 0x0a,
	0x06, 0x68, 0x61, 0x73, 0x68, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x68,
	0x61, 0x73, 0x68, 0x65, 0x73, 0x22, 0x46, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x4f, 0x0a,
	0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x22, 0x61,
	0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42,
	0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63,
	...
	,
	...
	0x6f, 0x6e, 0x48, 0x61, 0x73, 0x68, 0x22, 0xc2, 0x02, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x54, 0x72,
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x74, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x12, 0x37, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x76, 0x31,
	0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x22, 0x2c, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x4e, 0x6f,
	0x6e, 0x63, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x62,
	0x0a, 0x16, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x61, 0x73, 0x68, 0x22, 0xf1, 0x01, 0x0a, 0x16, 0x47, 0x65,
	0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52,
	...
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x61,
	...
	,
	...
	,
	...
	0x73, 0x12, 0x1c, 0x0a, 0x07, 0x73, 0x75, 0x62, 0x5f, 0x70, 0x76, 0x6b, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x73, 0x75, 0x62, 0x50, 0x76, 0x6b, 0x88, 0x01, 0x01, 0x42,
	0x0a, 0x0a, 0x08, 0x5f, 0x73, 0x75, 0x62, 0x5f, 0x70, 0x76, 0x6b, 0x22, 0x76, 0x0a, 0x1b, 0x47,
	0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x65, 0x69,
	0x67, 0x68, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x68,
	...
	0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x27, 0x0a, 0x0f, 0x72, 0x61,
	0x77, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x61, 0x77, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x22, 0x3e, 0x0a, 0x0a, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x49, 0x6e, 0x66,
	...
	,
	...
	0x53, 0x69, 0x7a, 0x65, 0x22, 0x77, 0x0a, 0x08, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x74, 0x65, 0x6d,
	...
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x69, 0x67,
	0x6e, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xd6, 0x03,
	0x0a, 0x15, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x6e, 0x57, 0x61, 0x6c, 0x6c, 0x65,
	0x74, 0x54, 0x78, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x72, 0x6f, 0x6d, 0x5f,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01,
	...
	,
	...
	0x1c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x6e, 0x41,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a,
	0x05, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x18, 0x02,
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x4f, 0x0a, 0x1a, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x31, 0x0a, 0x15, 0x69, 0x73, 0x5f, 0x6d, 0x75, 0x6c, 0x74,
	0x69, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x69, 0x73, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67,
	0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2a, 0x94, 0x01, 0x0a, 0x11, 0x54, 0x72, 0x61,
	...
	0x41, 0x54, 0x55, 0x53, 0x5f, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x00, 0x12, 0x1e,
	0x0a, 0x1a, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54,
	...
	,
	...
	0x70, 0x69, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x65, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x12, 0x5b, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x12, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e,
	...
	,
	...
	,
	...
	0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x72, 0x69, 0x63, 0x65,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x64, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x27, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	,
...
var file_block_v1_block_proto_msgTypes = make([]protoimpl.MessageInfo, 74)
var file_block_v1_block_proto_goTypes = []any{
	...
	(*SendTransactionWithBundleRequest)(nil),    // 14: api.block.v1.SendTransactionWithBundleRequest
	(*SendTransactionWithBundleReply)(nil),      // 15: api.block.v1.SendTransactionWithBundleReply
	(*GetTransactionStatusRequest)(nil),         // 16: api.block.v1.GetTransactionStatusRequest
	(*GetTransactionStatusReply)(nil),           // 17: api.block.v1.GetTransactionStatusReply
	(*GetExplorerURLRequest)(nil),               // 18: api.block.v1.GetExplorerURLRequest
	(*GetExplorerURLReply)(nil),                 // 19: api.block.v1.GetExplorerURLReply
	(*ValidateAddressRequest)(nil),              // 20: api.block.v1.ValidateAddressRequest
	(*ValidateAddressReply)(nil),                // 21: api.block.v1.ValidateAddressReply
	(*SubscribeTransactionRequest)(nil),         // 22: api.block.v1.SubscribeTransactionRequest
	(*SubscribeTransactionReply)(nil),           // 23: api.block.v1.SubscribeTransactionReply
	(*SubscribeTransactionItem)(nil),            // 24: api.block.v1.SubscribeTransactionItem
	(*GetTokenPriceRequest)(nil),                // 25: api.block.v1.GetTokenPriceRequest
	(*GetTokenPriceReply)(nil),                  // 26: api.block.v1.GetTokenPriceReply
	(*GetTokenPriceBatchRequest)(nil),           // 27: api.block.v1.GetTokenPriceBatchRequest
	(*GetTokenPriceBatchReply)(nil),             // 28: api.block.v1.GetTokenPriceBatchReply
	(*SwapRequest)(nil),                         // 29: api.block.v1.SwapRequest
	...
	(*GetUserResourceRequest)(nil),              // 51: api.block.v1.GetUserResourceRequest
	(*GetUserResourceReply)(nil),                // 52: api.block.v1.GetUserResourceReply
	(*GetTransferDetailRequest)(nil),            // 53: api.block.v1.GetTransferDetailRequest
	(*GetTransferDetailReply)(nil),              // 54: api.block.v1.GetTransferDetailReply
	(*GetTokenBalanceBatchByItemRequest)(nil),   // 55: api.block.v1.GetTokenBalanceBatchByItemRequest
	(*GetTokenBalanceBatchByItemReply)(nil),     // 56: api.block.v1.GetTokenBalanceBatchByItemReply
	(*GetChainIDRequest)(nil),                   // 57: api.block.v1.GetChainIDRequest
	(*GetChainIDReply)(nil),                     // 58: api.block.v1.GetChainIDReply
	(*BuildUpgradeMultiSigWalletTxRequest)(nil), // 59: api.block.v1.BuildUpgradeMultiSigWalletTxRequest
	(*MultiSigWalletItem)(nil),                  // 60: api.block.v1.MultiSigWalletItem
	(*BuildUpgradeMultiSigWalletTxReply)(nil),   // 61: api.block.v1.BuildUpgradeMultiSigWalletTxReply
	(*GetTransactionWeightRequest)(nil),         // 62: api.block.v1.GetTransactionWeightRequest
	(*SignerInfo)(nil),                          // 63: api.block.v1.SignerInfo
	(*GetTransactionWeightReply)(nil),           // 64: api.block.v1.GetTransactionWeightReply
	(*GetMultiSignWalletTxListRequest)(nil),     // 65: api.block.v1.GetMultiSignWalletTxListRequest
	(*SignItem)(nil),                            // 66: api.block.v1.SignItem
	(*MultiSignWalletTxItem)(nil),               // 67: api.block.v1.MultiSignWalletTxItem
	(*GetMultiSignWalletTxListReply)(nil),       // 68: api.block.v1.GetMultiSignWalletTxListReply
	(*CheckMultiSignAddressRequest)(nil),        // 69: api.block.v1.CheckMultiSignAddressRequest
	(*CheckMultiSignAddressReply)(nil),          // 70: api.block.v1.CheckMultiSignAddressReply
	nil,                                         // 71: api.block.v1.GetTokenBalanceBatchReply.BalanceResultEntry
	nil,                                         // 72: api.block.v1.GetTokenInfoBatchReply.InfoResultEntry
	nil,                                         // 73: api.block.v1.GetTokenPriceBatchReply.PriceResultEntry
	nil,                                         // 74: api.block.v1.CallBundleReply.ErrorsEntry
}
var file_block_v1_block_proto_depIdxs = []int32{
	...
	71, // 3: api.block.v1.GetTokenBalanceBatchReply.balance_result:type_name -> api.block.v1.GetTokenBalanceBatchReply.BalanceResultEntry
	8,  // 4: api.block.v1.GetTokenInfoBatchRequest.info_items:type_name -> api.block.v1.GetTokenInfoRequest
	72, // 5: api.block.v1.GetTokenInfoBatchReply.info_result:type_name -> api.block.v1.GetTokenInfoBatchReply.InfoResultEntry
	24, // 6: api.block.v1.SubscribeTransactionReply.transactions:type_name -> api.block.v1.SubscribeTransactionItem
	25, // 7: api.block.v1.GetTokenPriceBatchRequest.price_items:type_name -> api.block.v1.GetTokenPriceRequest
	73, // 8: api.block.v1.GetTokenPriceBatchReply.price_result:type_name -> api.block.v1.GetTokenPriceBatchReply.PriceResultEntry
	...
	74, // 12: api.block.v1.CallBundleReply.errors:type_name -> api.block.v1.CallBundleReply.ErrorsEntry
	...
	5,  // 16: api.block.v1.GetTokenBalanceBatchByItemReply.balance_result:type_name -> api.block.v1.GetTokenBalanceReply
	60, // 17: api.block.v1.BuildUpgradeMultiSigWalletTxRequest.owners:type_name -> api.block.v1.MultiSigWalletItem
	63, // 18: api.block.v1.GetTransactionWeightReply.permissions:type_name -> api.block.v1.SignerInfo
	63, // 19: api.block.v1.GetTransactionWeightReply.approved_list:type_name -> api.block.v1.SignerInfo
	63, // 20: api.block.v1.GetTransactionWeightReply.available_signers:type_name -> api.block.v1.SignerInfo
	66, // 21: api.block.v1.MultiSignWalletTxItem.sign_list:type_name -> api.block.v1.SignItem
	67, // 22: api.block.v1.GetMultiSignWalletTxListReply.tx_list:type_name -> api.block.v1.MultiSignWalletTxItem
	5,  // 23: api.block.v1.GetTokenBalanceBatchReply.BalanceResultEntry.value:type_name -> api.block.v1.GetTokenBalanceReply
	9,  // 24: api.block.v1.GetTokenInfoBatchReply.InfoResultEntry.value:type_name -> api.block.v1.GetTokenInfoReply
	26, // 25: api.block.v1.GetTokenPriceBatchReply.PriceResultEntry.value:type_name -> api.block.v1.GetTokenPriceReply
	18, // 26: api.block.v1.Block.GetExplorerURL:input_type -> api.block.v1.GetExplorerURLRequest
	20, // 27: api.block.v1.Block.ValidateAddress:input_type -> api.block.v1.ValidateAddressRequest
	4,  // 28: api.block.v1.Block.GetTokenBalance:input_type -> api.block.v1.GetTokenBalanceRequest
	6,  // 29: api.block.v1.Block.GetTokenBalanceBatch:input_type -> api.block.v1.GetTokenBalanceBatchRequest
	55, // 30: api.block.v1.Block.GetTokenBalanceBatchByItem:input_type -> api.block.v1.GetTokenBalanceBatchByItemRequest
	8,  // 31: api.block.v1.Block.GetTokenInfo:input_type -> api.block.v1.GetTokenInfoRequest
	10, // 32: api.block.v1.Block.GetTokenInfoBatch:input_type -> api.block.v1.GetTokenInfoBatchRequest
	25, // 33: api.block.v1.Block.GetTokenPrice:input_type -> api.block.v1.GetTokenPriceRequest
	27, // 34: api.block.v1.Block.GetTokenPriceBatch:input_type -> api.block.v1.GetTokenPriceBatchRequest
	29, // 35: api.block.v1.Block.Swap:input_type -> api.block.v1.SwapRequest
	32, // 36: api.block.v1.Block.Transfer:input_type -> api.block.v1.TransferRequest
	35, // 37: api.block.v1.Block.Approve:input_type -> api.block.v1.ApproveRequest
	12, // 38: api.block.v1.Block.SendTransaction:input_type -> api.block.v1.SendTransactionRequest
	14, // 39: api.block.v1.Block.SendTransactionWithBundle:input_type -> api.block.v1.SendTransactionWithBundleRequest
	37, // 40: api.block.v1.Block.CallBundle:input_type -> api.block.v1.CallBundleRequest
	39, // 41: api.block.v1.Block.SendPrivateTransaction:input_type -> api.block.v1.SendPrivateTransactionRequest
	41, // 42: api.block.v1.Block.CreateAddress:input_type -> api.block.v1.CreateAddressRequest
	43, // 43: api.block.v1.Block.CreateAddressBatch:input_type -> api.block.v1.CreateAddressBatchRequest
	45, // 44: api.block.v1.Block.GetTransactionByHash:input_type -> api.block.v1.GetTransactionByHashRequest
	47, // 45: api.block.v1.Block.GetLiquidity:input_type -> api.block.v1.GetLiquidityRequest
	49, // 46: api.block.v1.Block.GetPendingNonce:input_type -> api.block.v1.GetPendingNonceRequest
	51, // 47: api.block.v1.Block.GetUserResource:input_type -> api.block.v1.GetUserResourceRequest
	53, // 48: api.block.v1.Block.GetTransferDetail:input_type -> api.block.v1.GetTransferDetailRequest
	57, // 49: api.block.v1.Block.GetChainID:input_type -> api.block.v1.GetChainIDRequest
	59, // 50: api.block.v1.Block.BuildUpgradeMultiSigWalletTx:input_type -> api.block.v1.BuildUpgradeMultiSigWalletTxRequest
	62, // 51: api.block.v1.Block.GetTransactionWeight:input_type -> api.block.v1.GetTransactionWeightRequest
	65, // 52: api.block.v1.Block.GetMultiSignWalletTxList:input_type -> api.block.v1.GetMultiSignWalletTxListRequest
	69, // 53: api.block.v1.Block.CheckMultiSignAddress:input_type -> api.block.v1.CheckMultiSignAddressRequest
	19, // 54: api.block.v1.Block.GetExplorerURL:output_type -> api.block.v1.GetExplorerURLReply
	21, // 55: api.block.v1.Block.ValidateAddress:output_type -> api.block.v1.ValidateAddressReply
	5,  // 56: api.block.v1.Block.GetTokenBalance:output_type -> api.block.v1.GetTokenBalanceReply
	7,  // 57: api.block.v1.Block.GetTokenBalanceBatch:output_type -> api.block.v1.GetTokenBalanceBatchReply
	56, // 58: api.block.v1.Block.GetTokenBalanceBatchByItem:output_type -> api.block.v1.GetTokenBalanceBatchByItemReply
	9,  // 59: api.block.v1.Block.GetTokenInfo:output_type -> api.block.v1.GetTokenInfoReply
	11, // 60: api.block.v1.Block.GetTokenInfoBatch:output_type -> api.block.v1.GetTokenInfoBatchReply
	26, // 61: api.block.v1.Block.GetTokenPrice:output_type -> api.block.v1.GetTokenPriceReply
	28, // 62: api.block.v1.Block.GetTokenPriceBatch:output_type -> api.block.v1.GetTokenPriceBatchReply
	31, // 63: api.block.v1.Block.Swap:output_type -> api.block.v1.SwapReply
	33, // 64: api.block.v1.Block.Transfer:output_type -> api.block.v1.TransferReply
	36, // 65: api.block.v1.Block.Approve:output_type -> api.block.v1.ApproveReply
	13, // 66: api.block.v1.Block.SendTransaction:output_type -> api.block.v1.SendTransactionReply
	15, // 67: api.block.v1.Block.SendTransactionWithBundle:output_type -> api.block.v1.SendTransactionWithBundleReply
	38, // 68: api.block.v1.Block.CallBundle:output_type -> api.block.v1.CallBundleReply
	40, // 69: api.block.v1.Block.SendPrivateTransaction:output_type -> api.block.v1.SendPrivateTransactionReply
	42, // 70: api.block.v1.Block.CreateAddress:output_type -> api.block.v1.CreateAddressReply
	44, // 71: api.block.v1.Block.CreateAddressBatch:output_type -> api.block.v1.CreateAddressBatchReply
	46, // 72: api.block.v1.Block.GetTransactionByHash:output_type -> api.block.v1.GetTransactionByHashReply
	48, // 73: api.block.v1.Block.GetLiquidity:output_type -> api.block.v1.GetLiquidityReply
	50, // 74: api.block.v1.Block.GetPendingNonce:output_type -> api.block.v1.GetPendingNonceReply
	52, // 75: api.block.v1.Block.GetUserResource:output_type -> api.block.v1.GetUserResourceReply
	54, // 76: api.block.v1.Block.GetTransferDetail:output_type -> api.block.v1.GetTransferDetailReply
	58, // 77: api.block.v1.Block.GetChainID:output_type -> api.block.v1.GetChainIDReply
	61, // 78: api.block.v1.Block.BuildUpgradeMultiSigWalletTx:output_type -> api.block.v1.BuildUpgradeMultiSigWalletTxReply
	64, // 79: api.block.v1.Block.GetTransactionWeight:output_type -> api.block.v1.GetTransactionWeightReply
	68, // 80: api.block.v1.Block.GetMultiSignWalletTxList:output_type -> api.block.v1.GetMultiSignWalletTxListReply
	70, // 81: api.block.v1.Block.CheckMultiSignAddress:output_type -> api.block.v1.CheckMultiSignAddressReply
...
func file_block_v1_block_proto_init() {
	...
	file_block_v1_block_proto_msgTypes[23].OneofWrappers = []any{}
	file_block_v1_block_proto_msgTypes[28].OneofWrappers = []any{}
	file_block_v1_block_proto_msgTypes[31].OneofWrappers = []any{}
	file_block_v1_block_proto_msgTypes[32].OneofWrappers = []any{}
	file_block_v1_block_proto_msgTypes[60].OneofWrappers = []any{}
	type x struct{}
