...
const file_block_v1_block_proto_rawDesc = "" +
	...
	"\rparse_balance\x18\x03 \x01(\tR\fparseBalance\"h\n" +
	...
	"\x05chain\x18\x02 \x01(\tR\x05chain\x12\x18\n" +
	"\anetwork\x18\x03 \x01(\tR\anetwork\"\xe3\x01\n" +
	...
	"\x18parse_token_total_supply\x18\x05 \x01(\tR\x15parseTokenTotalSupply\"\\\n" +
	...
	"\x05chain\x18\x01 \x01(\tR\x05chain\x12\x18\n" +
	"\anetwork\x18\x02 \x01(\tR\anetwork\x12#\n" +
	"\rtoken_address\x18\x03 \x01(\tR\ftokenAddress\"\xc2\x01\n" +
	...
	"\x14liquidity_market_cap\x18\x04 \x01(\tR\x12liquidityMarketCap\"b\n" +
	...
	"\x05nonce\x18\x01 \x01(\x04R\x05nonce*\x94\x01\n" +
	...
	"\x1cTRANSACTION_STATUS_NOT_FOUND\x10\x032\xbb\r\n" +
	"\x05Block\x12X\n" +
	"\x0eGetExplorerURL\x12#.api.block.v1.GetExplorerURLRequest\x1a!.api.block.v1.GetExplorerURLReply\x12[\n" +
	...
	"\x04Swap\x12\x19.api.block.v1.SwapRequest\x1a\x17.api.block.v1.SwapReply\x12F\n" +
	...
	"\x0fSendTransaction\x12$.api.block.v1.SendTransactionRequest\x1a\".api.block.v1.SendTransactionReply\x12L\n" +
	"\n" +
	"CallBundle\x12\x1f.api.block.v1.CallBundleRequest\x1a\x1d.api.block.v1.CallBundleReply\x12p\n" +
	...
	"\x0fGetPendingNonce\x12$.api.block.v1.GetPendingNonceRequest\x1a\".api.block.v1.GetPendingNonceReplyB'\n" +
