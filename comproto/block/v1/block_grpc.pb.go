...
type BlockClient interface {
	// 获取浏览器URL
	GetExplorerURL(ctx context.Context, in *GetExplorerURLRequest, opts ...grpc.CallOption) (*GetExplorerURLReply, error)
	// 验证地址
...
func (c *blockClient) GetExplorerURL(ctx context.Context, in *GetExplorerURLRequest, opts ...grpc.CallOption) (*GetExplorerURLReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetExplorerURLReply)
	err := c.cc.Invoke(ctx, Block_GetExplorerURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blockClient) CallBundle(ctx context.Context, in *CallBundleRequest, opts ...grpc.CallOption) (*CallBundleReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CallBundleReply)
	err := c.cc.Invoke(ctx, Block_CallBundle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlockServer interface {
	// 获取浏览器URL
	GetExplorerURL(context.Context, *GetExplorerURLRequest) (*GetExplorerURLReply, error)
	// 验证地址
...
func (UnimplementedBlockServer) GetExplorerURL(context.Context, *GetExplorerURLRequest) (*GetExplorerURLReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetExplorerURL not implemented")
}
...
func _Block_GetExplorerURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetExplorerURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockServer).GetExplorerURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Block_GetExplorerURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockServer).GetExplorerURL(ctx, req.(*GetExplorerURLRequest))
	}
...
func _Block_CallBundle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CallBundleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockServer).CallBundle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Block_CallBundle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockServer).CallBundle(ctx, req.(*CallBundleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Block_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetExplorerURL",
			Handler:    _Block_GetExplorerURL_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Block_CallBundle_Handler,
		},
		{
