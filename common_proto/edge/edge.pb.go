...
var file_edge_v1_edge_proto_rawDesc = string([]byte{
	...
	0x61, 0x63, 0x6b, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x64, 0x32, 0x78, 0x0a, 0x04, 0x45, 0x64, 0x67,
	...
	0x65, 0x22, 0x00, 0x42, 0x35, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x2e, 0x65, 0x64, 0x67, 0x65, 0x2e,
...
var file_edge_v1_edge_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_edge_v1_edge_proto_depIdxs = []int32{
	0, // 0: api.edge.v1.Edge.CheckBlacklistAddress:input_type -> api.edge.v1.CheckBlacklistAddressRequest
	1, // 1: api.edge.v1.Edge.CheckBlacklistAddress:output_type -> api.edge.v1.CheckBlacklistAddressResponse
